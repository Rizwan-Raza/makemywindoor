...
class _DoorScreenState extends State<DoorScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(
        title: MyConstants.appbarTitle1[1],
      ),
      body: Column(
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: ListView(
                  ...
                  shrinkWrap: true,
                  children: MyConstants.doorScreenChips
                      .map((e) => Padding(
                            padding: const EdgeInsets.all(4.0),
                            child: FilterChip(
                              label: Text(e),
                              selected: selected ==
                                  MyConstants.doorScreenChips.indexOf(e),
                  ...
                  children: [
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: Image.asset(
                          MyConstants.doorData[MyConstants
                              .doorScreenChips[selected]]['imageUrl'],
                          fit: BoxFit.cover,
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          MyConstants.doorData[
                              MyConstants.doorScreenChips[selected]]['desc'],
                          ...
                          children: [
                            ...
                            ListView.builder(
                                ...
                                itemCount: MyConstants
                                    .doorData[MyConstants
                                        .doorScreenChips[selected]]['features']
                                    .length,
                                itemBuilder: (BuildContext context, int index) {
                                  // MyConstants
                                  //     .windowsData[MyConstants
                                  //             .doorScreenChips[selected]]
                                  //         ['features']
                                  //     .keys.toList()[index];
        ...
        children: [
          ...
          Expanded(
            ...
            children: [
              ...
              Flexible(
                child: Text(
                  MyConstants.doorData[MyConstants.doorScreenChips[selected]]
                      [key],
                  overflow: TextOverflow.visible,
                  maxLines: 3,
                  //  reversed.entries.key,
